...
function setup() {
	...
	leftBox = Bodies.rectangle(width/2 - 83, 585, 20, 100, {isStatic:true});
    World.add(world, leftBox);
    rightBox = Bodies.rectangle(width/2 + 83, 585, 20, 100, {isStatic:true});
    World.add(world, rightBox);
    bottomBox = Bodies.rectangle(width/2, 630, 190, 20, {isStatic:true});
...
function draw() {
  ...
  rect(bottomBox.position.x, bottomBox.position.y, 190, 20);
